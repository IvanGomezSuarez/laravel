...
<div id='' class="container">
    ...
    <div class="row">
        <div class='col-lg-5'>
            ...
            <form  class="asignatio" action="@if (Request::get('edita')) cursos/update @else cursos/crea @endif" method="post">
                @csrf
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="fdorm-group row mb-3">
                            <div class="col-sm-6">
                                ...
                                <input required type="date" class="form-control fullwidth" id="" name="date_start" placeholder="Dia inicio" value="@if (Request::get('edita')){{$cursoId->date_start}}@endif" >
                            </div>
                            <div class="col-sm-6">
                                <label for="">Finaliza</label>
                                <input  required type="date" class="form-control fullwidth" id="" name="date_end" placeholder="Dia final" value="@if (Request::get('edita')){{$cursoId->date_end}}@endif">
                            </div>
                        </div>
                        <div class="input-group mb-3">
        ...
        <div class="col-lg-7">
            <form class="asignatio" action="" method="">
                ...
                <div class="form-group editasign">
                    ...
                    <input type="submit" formaction="cursos/borra" name="borra" value="Borra" class="btn btn-primary mb-2">
