...
<?php
if (isset($_GET['yaexiste'])&&($_GET['yaexiste']=='true')){

    echo '<script>alert("Usuario ya existe elegir otro");window.location.href = "/registrar";</script>';

}
    if (isset($_GET['yaexiste'])&&($_GET['yaexiste']=='false')){

     echo '<script>alert("Usuario Guardado correctamente");window.location.href = "/";</script>';
...
<div id="" class="container-md mt-14" >
    <form class="col-sm-8 col-lg-6 col-md-6 offset-sm-2 offset-md-3 offset-lg-3 border login">
        @csrf
        ...
        <button formaction="registro" type="submit" class="btn btn-primary text-center">Registrar</button>
