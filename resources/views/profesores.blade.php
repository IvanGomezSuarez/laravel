                ...
                <form class="asignatio" action="" method="post">
                    ...
                    <div class="form-group editasign">
                        ...
                        <div class=" mb-3">
                            ...
                            <input required autocomplete=“off” type="text" class="form-control" name="email" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" value="@if (Request::post('edita')) {{$profesorId['email']}} @endif">
                        </div>
                            <div class=" mb-3">
